...
def test_static_from_relax_si(Si, species_dir, tmp_path, ref_path):
    comp_system(Si, f"{ref_path}/relax-si/", "static-from-prev-si", tmp_path, ref_path, species_dir)


def test_static_from_relax_si_no_kgrid(Si, species_dir, tmp_path, ref_path):
    comp_system(
        Si, f"{ref_path}/relax-no-kgrid-si/", "static-from-prev-no-kgrid-si", tmp_path, ref_path, species_dir
    )
...
def test_static_from_relax_default_species_dir(Si, species_dir, tmp_path, ref_path):
    ...
    comp_system(
        Si, f"{ref_path}/relax-default-sd-si/", "static-from-prev-default-sd-si", tmp_path, ref_path, species_dir
    )
...
def test_static_from_relax_o2(O2, species_dir, tmp_path, ref_path):
    comp_system(O2, f"{ref_path}/relax-o2/", "static-from-prev-o2", tmp_path, ref_path, species_dir)
...
def test_static_from_relax_default_species_dir_o2(O2, species_dir, tmp_path, ref_path):
    ...
    comp_system(
        O2, f"{ref_path}/relax-default-sd-o2/", "static-from-prev-default-sd-o2", tmp_path, ref_path, species_dir
    )
